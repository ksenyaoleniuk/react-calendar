...
wrapper ? _reactDom2.default.render(_react2.default.createElement(_Calendar2.default, null), wrapper) : false;
...
var _MonthDates = __webpack_require__(20);
...
var MonthDates = function (_Component) {
    ...
    function MonthDates() {
        ...
        return _possibleConstructorReturn(this, (MonthDates.__proto__ || Object.getPrototypeOf(MonthDates)).call(this));
    }
    ...
    _createClass(MonthDates, [{
        ...
        value: function renderDay(d, daysInMonth) {
            var length = 7;
            return Array(length).fill(null).map(function (item, i) {
                d += 1;
                if (d > 0 && d <= daysInMonth) {
                    //check if the date is positive and the date exists in the current month
                    return _react2.default.createElement(
                        "div",
        ...
        key: "renderRows",
        value: function renderRows(day, daysInMonth) {
            var _this2 = this;

            var rows = 5;
            return Array(rows).fill(null).map(function (item, i) {
                var d = day + i * 7;
                return _react2.default.createElement(
                    "div",
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("button", { className: "calendar__nav_prev",
                    onClick: this.props.onPrev.bind(this) }),
                _react2.default.createElement(
                    "div",
                    { className: "calendar__title" },
                    monthNamesFull[this.props.month]
                ),
                _react2.default.createElement("button", { className: "calendar__nav_next",
